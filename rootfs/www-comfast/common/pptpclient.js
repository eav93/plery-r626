define(function (require, exports) {
    ...
    function refresh_remote() {
        if (pptp_info) {
            ...
            if (pptp_info.pptp_client_address) {
                d("#pptp_ip").html(pptp_info.pptp_client_address);
            } else {
    ...
    function set_config(arg) {
        f.setPPTPclient(arg, function (data) {
            if (data.errCode != 0) {
                lock_web = false;
