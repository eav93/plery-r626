(function(d) {
    var a = function(i,nowLang) {
        return new a.fn.init(i,nowLang)
    };
    var c = "",
        g = 0,
        f = 10000,
    ...
    a.fn = a.prototype = {
        ...
        _html: function(j) {
            ...
            i += '<tr r-drag="yes"><td valign="top"><div class="c_title" ><span>' + this.title + '</span></div><span href="javascript:void(0);" class="close" title="close" r-btn="close"></span></td></tr>';
    ...
    a.blank = function(k, j) {
        ...
        if ($.browser.version == "6.0" || $.browser.version == "7.0" || $.browser.version == "8.0") {
            ...
            i.css("border-color", "rgba(253, 253, 0, 0.5)")
        }
        j = j - 1;
