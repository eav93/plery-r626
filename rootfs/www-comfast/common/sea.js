...
;(function () {
	seajs.config({
		...
		alias: {
			...
			'appendselect': '/common/lib/append_select',
			'optionwifi': '/common/lib/option_wifi',
			'slideControl': '/common/lib/jquery.slideControl',
			'checkbox': '/common/lib/jquery.checkbox',
			'upload': '/common/lib/jquery.upload',
			'shpages': '/common/lib/jquery.shpages',
